...
namespace FacturareOnline\Inc\Libraries\JsonSchema\Constraints;

use FacturareOnline\Inc\Libraries\JsonSchema\Exception\InvalidArgumentException;
use FacturareOnline\Inc\Libraries\JsonSchema\SchemaStorage;
use FacturareOnline\Inc\Libraries\JsonSchema\SchemaStorageInterface;
use FacturareOnline\Inc\Libraries\JsonSchema\Uri\UriRetriever;
use FacturareOnline\Inc\Libraries\JsonSchema\UriRetrieverInterface;
use FacturareOnline\Inc\Libraries\JsonSchema\Validator;
...
class Factory
{
    ...
    protected $constraintMap = array(
        'array' => 'FacturareOnline\Inc\Libraries\JsonSchema\Constraints\CollectionConstraint',
        'collection' => 'FacturareOnline\Inc\Libraries\JsonSchema\Constraints\CollectionConstraint',
        'object' => 'FacturareOnline\Inc\Libraries\JsonSchema\Constraints\ObjectConstraint',
        'type' => 'FacturareOnline\Inc\Libraries\JsonSchema\Constraints\TypeConstraint',
        'undefined' => 'FacturareOnline\Inc\Libraries\JsonSchema\Constraints\UndefinedConstraint',
        'string' => 'FacturareOnline\Inc\Libraries\JsonSchema\Constraints\StringConstraint',
        'number' => 'FacturareOnline\Inc\Libraries\JsonSchema\Constraints\NumberConstraint',
        'enum' => 'FacturareOnline\Inc\Libraries\JsonSchema\Constraints\EnumConstraint',
        'format' => 'FacturareOnline\Inc\Libraries\JsonSchema\Constraints\FormatConstraint',
        'schema' => 'FacturareOnline\Inc\Libraries\JsonSchema\Constraints\SchemaConstraint',
        'validator' => 'FacturareOnline\Inc\Libraries\JsonSchema\Validator'
    );
    ...
    public function setConstraintClass($name, $class)
    {
        ...
        if (!in_array('FacturareOnline\Inc\Libraries\JsonSchema\Constraints\ConstraintInterface', class_implements($class))) {
