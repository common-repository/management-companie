...
class Curl extends AbstractRetriever
{
     ...
     * {@inheritdoc}
     *
     * @see \FacturareOnline\Inc\Libraries\JsonSchema\Uri\Retrievers\UriRetrieverInterface::retrieve()
     */
    public function retrieve($uri)
    {
        ...
        if (false === $response) {
            throw new \FacturareOnline\Inc\Libraries\JsonSchema\Exception\ResourceNotFoundException('JSON schema not found');
        }
